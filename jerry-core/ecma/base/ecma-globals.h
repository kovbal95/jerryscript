...
#elif CONFIG_ECMA_NUMBER_TYPE == CONFIG_ECMA_NUMBER_INT
#define ECMA_INTEGER_NUMBER_MIN          -0x8000000
#define ECMA_INTEGER_NUMBER_MIN_SHIFTED (-0x7fffffff - 1)
#endif /* CONFIG_ECMA_NUMBER_TYPE == CONFIG_ECMA_NUMBER_FLOAT32 */
...
#elif CONFIG_ECMA_NUMBER_TYPE == CONFIG_ECMA_NUMBER_INT
# define ECMA_NUMBER_MIN_VALUE ((ecma_number_t) INT64_MIN)
# define ECMA_NUMBER_MAX_VALUE ((ecma_number_t) INT64_MAX)
#endif /* CONFIG_ECMA_NUMBER_TYPE == CONFIG_ECMA_NUMBER_FLOAT32 */
